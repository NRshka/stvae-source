...
def benchmark_scvi(dataset_class, dataset_name, cfg, **kwargs):
    ...
    cfg.count_classes = np.max(dataset.batch_indices) + 1
    cfg.count_labels = np.max(dataset.labels) + 1
